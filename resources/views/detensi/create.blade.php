...
@section('title', 'Tambah Deteni - Rudenim Surabaya')

@section('main-content')
<header class="bg-white border-b border-gray-100 px-8 py-5 flex items-center justify-between">
    <div>
        <h1 class="text-2xl font-bold text-[#001845]">Tambah Deteni Baru</h1>
        <p class="text-xs text-gray-400 mt-0.5">Masukkan data deteni baru secara lengkap dan valid.</p>
    </div>
...
<div class="p-8 max-w-2xl">
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
        <form action="{{ route('detensi.store') }}" method="POST" class="space-y-5">
            @csrf

            {{-- Nama Deteni --}}
            <div class="space-y-1.5">
                <label class="text-sm font-semibold text-gray-600">Nama Lengkap</label>
                <input type="text" name="nama" value="{{ old('nama') }}" required placeholder="Masukkan nama sesuai paspor"
            ...
            <div class="space-y-1.5">
                ...
                <input type="text" name="negara" value="{{ old('negara') }}" required placeholder="Contoh: Pakistan, Malaysia"
            ...
            <div class="space-y-1.5">
                ...
                <input type="text" name="paspor" value="{{ old('paspor') }}" required placeholder="Contoh: A1234567"
            ...
            <div class="pt-4 flex justify-end gap-3">
                ...
                <button type="submit" class="px-6 py-2.5 rounded-xl text-sm font-bold text-white bg-blue-600 hover:bg-blue-700 transition-colors shadow-sm shadow-blue-100">Simpan Data</button>
            </div>
        </form>
    </div>
</div>
